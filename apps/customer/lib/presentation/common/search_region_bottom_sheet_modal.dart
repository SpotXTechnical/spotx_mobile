...
void showSearchRegionBottomSheetModal(
  BuildContext context,
  Function(bool, List<Region>?) onApplyClickedAction,
  RegionEvent loadMoreEvent,
) {
  showModalBottomSheet(
      isScrollControlled: true,
      context: context,
      builder: (context) => BlocProvider<SubRegionBloc>(
            create: (ctx) => SubRegionBloc(RegionsRepository())..add(const InitRegions()),
            child: BlocBuilder<SubRegionBloc, RegionState>(
              ...
              return Container(
                  ...
                  child: Column(children: [
                      ...
                      onChanged: (searchQuery) {
                        EasyDebounce.debounce(
                          ...
                          if (searchQuery.isNotEmpty) {
                            subRegionBloc.add(InitRegionsAndSubRegions(
                            ...
                            subRegionBloc.add(const InitRegions());
                          }
                        });
                      },
                    ...
                    if (state.regions != null && state.regions!.isEmpty)
                           Expanded(
                              child: Center(
                                  child: Text(LocaleKeys.noDataMessage.tr())))
                        ...
                        child: Container(
                          ...
                          child: SubRegionSpecialPaginationList<Region>(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      if (state.selectedRegions
                                              ?.map((e) => e.id)
                                              .contains(subRegion.id) ??
                                          false)
                                        SizedBox(
                                            width: 15,
                                            height: 15,
                                            child: Image.asset(doneIconPath))
                                    ],
                                  ),
                                ),
                                onTap: () {
                                  subRegionBloc.add(
                                      AddOrRemoveSelectedSubRegion(
                            ...
                            prefixLeadingWidget: GestureDetector(
                              ...
                              onTap: () {
                                subRegionBloc
                                    .add(const SetAllSubRegionsSelected());
                              },
                            ),
                    ...
                    Container(
                      ...
                      child: AppButton(
                        ...
                        action: () async {
                          onApplyClickedAction(
                              state.isAllSelected, state.selectedRegions);
