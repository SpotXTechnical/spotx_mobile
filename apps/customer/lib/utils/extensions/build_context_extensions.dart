...
import 'package:spotx/utils/widgets/alerts/base_image_alert.dart';
import 'package:spotx/utils/widgets/alerts/confirmation_alert.dart';
import 'package:spotx/utils/widgets/alerts/normal_alert.dart';
...
extension DialogExtensions on BuildContext {
  ...
  Future<bool?> showImageAlert({
    ...
    final bool? result = await showDialog<bool>(
      ...
      barrierColor: Colors.black.withOpacity(0.4),
      barrierDismissible: isDismissible,
      builder: (BuildContext context) => BaseImageAlert(
          title: title,
          body: body,
