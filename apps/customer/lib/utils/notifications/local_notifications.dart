...
void initLocalNotification() async {
  ...
  await flutterLocalNotificationsPlugin.initialize(initializationSettings, /*onDidReceiveNotificationResponse: (String? payLoad) {
...
Future<void> showLocalNotification(RemoteMessage message) async {
  debugPrint("here is the message");
  debugPrint("$message.notification");
  debugPrint("show local notification, title: ${message.notification?.title}");
  debugPrint("show local notification, body: ${message.notification?.body}");
