...
class CalendarStyle {
  ...
  final Color? reservedHighlightColor;
  ...
  final Decoration? reservedDecoration;

  final Decoration? pendingDecoration;
  ...
  CalendarStyle({
    ...
    this.reservedDecoration,
    this.pendingDecoration,
