...
class HeaderStyle {
  ...
  final Widget leftChevronIcon = const LocaleIconDirection(icon: arrowCircleLeftIconPath);

  /// Widget used for right chevron.
  ///
  /// Tapping on it will navigate to next calendar page.
  final Widget rightChevronIcon = const LocaleIconDirection(icon: arrowCircleRightIconPath);
